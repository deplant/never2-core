...
public class Elector {
    ...
    public static Elector ofDeploy(ContractTemplate template, Giver giver, Sdk sdk, Credentials governanceKeys) throws Sdk.SdkException {
        ...
        return new Elector(AccountController.ofAddress(template.abi(), address, sdk, governanceKeys, null));
    }
}
